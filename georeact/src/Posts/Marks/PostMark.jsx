  ...
  return (
    <div className="flex mb-4 items-center">
      <div className="w-full text-grey-darkest">
        <span> {postMark.body}</span>
      </div>
      <div className="w-full ml-20 text-grey-darkest items-center ">
        <span content-center >
          <Link className="underline self-center text-blue-600 hover:text-blue-700 transition duration-300 ease-in-out mb-4" to={postMark.ruta}>{postMark.ruta}</Link>
        </span>
      </div>
